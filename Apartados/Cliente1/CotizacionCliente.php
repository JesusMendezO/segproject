        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="ml-3">Apartado: Cotización a Clientes</h1>
                        </div>
                        <!-- /.col -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card-header">
                                <h1 class="card-title">Información de Cotizaciones a Clientes</h3>
                            </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <a href="../Cliente/GenerarCotCliente.php"><button type="button" class="btn btn-success">Ver Detalle</button></a>
