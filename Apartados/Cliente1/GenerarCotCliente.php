        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="ml-3">Apartado: Cotización a Clientes
                            </h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                                    ...
                                    <form class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <h4 style=" font-size:20px;font-weight:bold;margin:auto;margin-bottom:4px;border-bottom-style: solid;border-bottom-color: #03fc5e;">
                                                Productos Seleccionados Según: Presupuesto</h4>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-12" style="margin-bottom:1%">
                                                ...
                                                <button type="button" class="btn btn-primary" style="margin-left: 75%;">Guardar</button>
                                                <button type="button" class="btn btn-success">Generar PDF</button>
                                                <a href="../Cliente/CotizacionCliente.php"><button type="button" class="btn btn-secondary">Atras</button></a>
