        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                          <h1 class="ml-3">Apartado: Necesidades</h1>
                        ...
                        <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-header">
                                <h1 class="card-title">Información de Necesidades</h3>
                              </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <a href="../Cliente/PantallaPrueba.php"><button type="button" class="btn btn-info">Ver Detalle</button></a>
