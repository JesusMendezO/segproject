        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Servicios de Mantención: Check List - CCTV</h1>
                        </div>
                        <!-- /.col -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="../../PhP/Insertar_CheckCCTV.php">
                                        ...
                                        <h4 style="font-size:20px;font-weight:bold;margin:auto;margin-bottom:4px;border-bottom-style: solid;border-bottom-color: #1eff56;">
                                            Detalle de Equipos de Activación</h4>

                                        <div class="form-row">

                                            <div class="form-group col-md-6">
                                                <label for="inputPlazoPago">Equipos De Activación</label>
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text"><i class="fas fa-building"></i>
                                                    </div>
                                                    <select class="form-control" name="EActivacion[]">
                                                        <?php
                                                        $sql = ("SELECT * FROM equiposactivacioncctv");
                                                        $query = $conn->query($sql);
                                                        while ($valores = mysqli_fetch_array($query)) {
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <label for="inputDireccionPago">Cantidad:</label>
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="MarcaModelo[]" id="MarcaModelo[]" placeholder="Ingrese la marca o modelo del producto">
                                                </div>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPlazoPago">Estado de Equipo</label>
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text"><i class="fas fa-building"></i>
                                                    </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <label for="inputDireccionPago">Observación:</label>
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail5">Agregar Más</label>
                                                <div class="input-group-prepend">
