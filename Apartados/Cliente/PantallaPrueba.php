    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="ml-3" style="margin-bottom: -10%;">Apartado: Necesidades</h1>
                  ...
                  <form class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group-prepend">
                            <div class="input-group-text" style="background-color:red">Folio Nec.:
                            </div>
                    ...
                    <div class="form-group col-md-12">
                      <h4 style=" font-size:20px;font-weight:bold;margin:auto;margin-bottom:4px;border-bottom-style: solid;border-bottom-color: #03fc5e;">
                        Productos Necesarios (Segun Contrato)</h4>
                    ...
                    <div class="form-group col-md-6">
                      <h4 style=" font-size:20px;font-weight:bold;margin:auto;margin-bottom:4px;border-bottom-style: solid;border-bottom-color: #03fc5e;">
                        Productos disponibles en Bodega</h4>
                    ...
                    <div class="form-group col-md-12" style="margin-bottom:1%">
                      ...
                      <button type="button" class="btn btn-primary" style="margin-left: 71%;">Guardar</button>
                      <a href="../Cliente/Necesidades.php"><button type="button" class="btn btn-secondary">Atras</button></a>
                    </div>
