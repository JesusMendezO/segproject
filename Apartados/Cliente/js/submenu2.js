...
for (i=0;i<html2.length;i++) {
    ...
    //  //escribir menu desplegable
       for (j=0;j<areas[i].length;j++) {
           submenu[i].innerHTML += "<p><a href='"+enlaces[i][j]+"'>"+html3[i][j]['descrip1']+"</a> <Button style='margin-left: 5%;' type='button' class='btn btn-primary' data-toggle='modal' data-target='#FichaProductos'>Productos</Button></p>";
          }
