                                    ...
                                    <form class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text" style="background-color:red">Folio Presup:
                                                        </div>
                                            ...
                                            <table id="example2" class="table table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Total Costo</th>
                                                        <th>Precio Venta Und.</th>
                                                        <th>Total Venta</th>
                                                        <th>Margen</th>
                                                        <th>Porcentaje Margen</th>
                                                        <th>Acciones</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="seleccion" name="seleccion">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="../../CRUD/DELETE_Bodega.php"><button type="button" class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-12" style="margin-bottom:1%">
                                                ...
                                                <button type="button" class="btn btn-warning">Crear Cotización (Adquisiciones)</button>
                                                <button type="button" class="btn btn-success">Crear Cotización (Cliente)</button>
                                                <a href="../Adquisiciones/ReqBodegaLista.php"><button type="button" class="btn btn-info">Req. Bodega</button></a>
                                                <button type="button" class="btn btn-primary" style="margin-left: 35%;">Guardar</button>
