        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Sección Ordenes de Compra</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <h3 class="card-tittle">Información de Ordenes de Compra</h3>
                            </div>
                        <div class="card-body">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../Adquisiciones/IngresarCompra.php"><button type="button" class="btn btn-primary">Factura</button></a>
