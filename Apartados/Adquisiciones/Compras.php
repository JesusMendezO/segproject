        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Sección Compras</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <!-- Button trigger modal -->
                                ...
                                <!--a href="../Adquisiciones/FacturaCompra.php"><button type="button" class="btn btn-primary">
                                    Ingresar Compra (Sin Factura)
                                </button></a-->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                            <h3 class="card-tittle">Información de Compras</h3>
                            </div>
                        <div class="card-body">
                            ...
                            <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"><button type="button" class="btn btn-warning">Imprimir Comprobante</button></a>
