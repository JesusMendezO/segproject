                    ...
                    <div class="row">
                        ...
                        <div class="card">
                             <div class="card-header">
                                <h1 class="card-title" style="font-weight: bold;">Información de Necesidades</h3>
                              </div>
                        <div class="card-body">
                            ...
                            <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <a href="../Adquisiciones/ReqBodega.php"><button type="button" class="btn btn-info">Ver Detalle</button></a>
