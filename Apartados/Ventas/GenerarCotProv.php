    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
             <div class="col-sm-6">
                  <h1 class="ml-3">Apartado: Cotización a Proveedores</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                   ...
                   Datos Cliente</h4>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group-prepend">
                            <div class="input-group-text" style="background-color:red">Folio Cot.:
                            </div>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group-prepend">
                            <div class="input-group-text" style="background-color:lightgreen">Contrato:
                            </div>
                            <input type="number" class="form-control" name="folio" id="folio">
                          </div>
                    ...
                    <div class="form-group col-md-12">
                      <h4 style=" font-size:20px;font-weight:bold;margin:auto;margin-bottom:4px;border-bottom-style: solid;border-bottom-color: #03fc5e;">
                        Productos a Necesitar (Segun Contrato)</h4>
                      <table id="example2" class="table table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th>Cantidad a Cot.</th>
                            <th>Precio Costo Und.</th>
                            <th>Total Costo</th>
                          </tr>
                        </thead>
                    ...
                    <div class="form-group col-md-12" style="margin-bottom:1%">
                    ...
                    <div class="form-group col-md-6">
                          <label for="inputNombreCliente">Proveedores:</label>
                          <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fas fa-user"></i>
                            </div>
                            <select class="form-control" name="id" id="id">
                            <option value="0">Selecione un Provedor</option>
                              <?php
                    ...
                    <div class="form-group col-md-6">
                      <h4 style=" font-size:20px;font-weight:bold;margin-bottom:4px;border-bottom-style: solid;border-bottom-color: #00c0ef;">
                    ...
                    <div class="form-group col-md-12" style="margin-bottom:1%">
                      ...
                      <a href="../Ventas/CotizacionProveedorCompara.php"><button type="button" class="btn btn-warning" style="margin-left: 63%;">Cot. Comparación</button></a>
                      <button type="button" class="btn btn-success">Crear PDF</button>
                      <button type="button" class="btn btn-primary">Guardar</button>
                      <a href="../Ventas/CotizacionProveedor.php"><button type="button" class="btn btn-secondary">Atras</button></a>
