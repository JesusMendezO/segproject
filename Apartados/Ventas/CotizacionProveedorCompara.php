                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card-header">
                                <h1 class="card-title">Información de Cotizaciones a Proveedores</h3>
                              </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <a href="../Ventas/GenerarCotProv.php"><button type="button" class="btn btn-success">Ver Detalle</button></a>
